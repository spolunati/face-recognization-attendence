...
def check_haarcascadefile():
    exists = os.path.isfile(r'C:\Users\sahit\Downloads\haarcascade_frontalface_default (1).xml')
    if exists:
        pass
    else:
...
def TakeImages():
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        harcascadePath = r'C:\Users\sahit\Downloads\haarcascade_frontalface_default (1).xml'
